  ...
  return (
    <div className="animate-fade-in">
      ...
      <div className="rounded-lg border bg-hymn-card text-card-foreground shadow-sm border-border/50 py-6">
        <div className="flex items-center justify-between gap-3 mb-6 pl-2">
          <div className="flex min-h-10 min-w-10 items-center justify-center rounded-full bg-primary/10 text-primary font-bold text-lg">
            {hymn.numero}
          </div>
          <h3 className="text-xl text-center font-semibold leading-none tracking-tight text-primary">
            {hymn.titulo}
          </h3>
        ...
        <div
          className="hymn-content text-center"
              ...
              <div key={index} className="verse">
                <div className="text-hymn-text leading-relaxed whitespace-pre-line">
                  {estrofe.map((line, lineIndex) => (
                    <div
                      key={lineIndex}
                      className={cn("verse-line", { italic: line.italico })}
                    >
                      {line.texto}
                    </div>
                  ))}
