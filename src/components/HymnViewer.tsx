...
export function HymnViewer({ hymn }: HymnViewerProps) {
  ...
  return (
    <div className="animate-fade-in">
      ...
      <div className="rounded-lg border bg-hymn-card text-card-foreground shadow-sm border-border/50 py-6 px-2">
        <div className="flex items-center justify-between gap-3 mb-6">
          <div className="select-none flex min-h-10 min-w-10 items-center justify-center rounded-full bg-primary/10 text-primary font-bold text-md">
            {hymn.numero}
          </div>
